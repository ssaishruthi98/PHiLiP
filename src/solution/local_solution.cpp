...
#if (PHILIP_DIM+PHILIP_SPECIES+1) > 7 && (PHILIP_DIM+PHILIP_SPECIES+1)!=14
    template class LocalSolution<double, PHILIP_DIM, PHILIP_SPECIES, PHILIP_DIM+PHILIP_SPECIES+1>;
#endif
}  // namespace PHiLiP
