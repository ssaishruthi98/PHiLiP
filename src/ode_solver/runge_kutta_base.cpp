...
#define POSSIBLE_NSTAGES (1)(2)(3)(4)(5)(9)(10)
...
BOOST_PP_SEQ_FOR_EACH(INSTANTIATE_TRIA, _, POSSIBLE_NSTAGES)
...
#if PHILIP_DIM!=1
BOOST_PP_SEQ_FOR_EACH(INSTANTIATE_DISTRIBUTED, _, POSSIBLE_NSTAGES)
#endif
