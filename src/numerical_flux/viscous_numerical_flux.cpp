    ...
    const int boundary_type) const
{
    ...
    phys_flux_int_dot_n = pde_physics->dissipative_flux_dot_normal (soln_int, soln_grad_int, on_boundary, current_cell_index, normal_int, boundary_type);
    phys_flux_ext_dot_n = pde_physics->dissipative_flux_dot_normal (soln_ext, soln_grad_ext, on_boundary, neighbor_cell_index, normal_int, boundary_type);
    ...
    const int boundary_type) const
{
    ...
    A_jumpu_int_dot_n = pde_physics->dissipative_flux_dot_normal (soln_int, soln_jump, on_boundary, current_cell_index, normal_int, boundary_type);
    A_jumpu_ext_dot_n = pde_physics->dissipative_flux_dot_normal (soln_ext, soln_jump, on_boundary, neighbor_cell_index, normal_int, boundary_type);
