        ...
        const bool use_auxiliary_eq)
{
    ...
    // ADAPTIVE FLUX RECONSTRUCTION : For switching between cDG and c10Thousand
    ...
    //std::cout << "cell loop done." << std::endl << std::endl;
