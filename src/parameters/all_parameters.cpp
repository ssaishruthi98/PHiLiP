...
void AllParameters::declare_parameters (dealii::ParameterHandler &prm)
{
    ...
    prm.declare_entry("number_of_species", "1",
                      ...
                      "Number of species. "
                      "Default number of species is 1. For number_of_species > 1, only "
                      "multispecies_calorically_perfect_euler and multispecies_thermally_perfect_euler pde_type can be used.");
    ...
    prm.declare_entry("two_point_num_flux_type", "KG",
                      ...
                      "KG | IR | CH | Ra | Re"),
                      "Two point flux type. "
                      "Choices for single species are <KG | IR | CH | Ra | Re>."
    ...
    prm.declare_entry("test_type", "run_control",
                      ...
                      " multispecies_euler_split_taylor_green"),
...
const std::string test_string = prm.get("test_type");
    ...
    else if (test_string == "multispecies_euler_split_taylor_green")              { test_type = multispecies_euler_split_taylor_green; }
    ...
    if (two_point_num_flux_string == "Re") { two_point_num_flux_type = TwoPointNumericalFlux::Re; }
