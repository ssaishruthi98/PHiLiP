#ifndef __H_REFINEMENT_STUDY_SOD_SHOCK_TUBE__
#define __H_REFINEMENT_STUDY_SOD_SHOCK_TUBE__
...
class HRefinementStudySodShockTube: public TestsBase
{
public:
    /// Constructor
    HRefinementStudySodShockTube(
