...
int TaylorGreenVortexRestartCheck<dim, nstate>::run_test() const
{
    ...
    flow_solver_case->compute_and_update_integrated_quantities(*(flow_solver_restart_to_complete_run->dg),*(flow_solver_restart_to_complete_run->ode_solver->limiter->use_limiter));
