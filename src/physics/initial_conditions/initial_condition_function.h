...
*/
template <int dim, int nspecies, int nstate, typename real>
class InitialConditionFunction_MultiSpecies_SodShockTube: public InitialConditionFunction_MultiSpeciesCaloricallyPerfectGasBase<dim,nspecies,nstate,real>
{
protected:
    /// Value of initial condition expressed in terms of primitive variables
    real primitive_value(const dealii::Point<dim, real>& point, const unsigned int istate = 0) const override;
