...
*/
template <int dim, int nstate, typename real>
class InitialConditionFunction_ExplosionProblem : public InitialConditionFunction_NavierStokesBase<dim, nstate, real>
{
protected:
    /// Value of initial condition expressed in terms of primitive variables
    real primitive_value(const dealii::Point<dim, real>& point, const unsigned int istate = 0) const override;
...
*/
template <int dim, int nstate, typename real>
class InitialConditionFunction_DoubleMachReflection : public InitialConditionFunction_NavierStokesBase<dim, nstate, real>
{
protected:
    /// Value of initial condition expressed in terms of primitive variables
    real primitive_value(const dealii::Point<dim, real>& point, const unsigned int istate = 0) const override;
...
*/
template <int dim, int nstate, typename real>
class InitialConditionFunction_SedovBlastWave : public InitialConditionFunction_NavierStokesBase<dim, nstate, real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
*/
template <int dim, int nstate, typename real>
class InitialConditionFunction_Mach3WindTunnel : public InitialConditionFunction_NavierStokesBase<dim, nstate, real>
{
protected:
    /// Value of initial condition expressed in terms of primitive variables
    real primitive_value(const dealii::Point<dim, real>& /*point*/, const unsigned int istate = 0) const override;
...
*/
template <int dim, int nstate, typename real>
class InitialConditionFunction_ShockDiffraction : public InitialConditionFunction_NavierStokesBase<dim, nstate, real>
{
protected:
    /// Value of initial condition expressed in terms of primitive variables
    real primitive_value(const dealii::Point<dim, real>& point, const unsigned int istate = 0) const override;
...
*/
template <int dim, int nstate, typename real>
class InitialConditionFunction_AstrophysicalJet : public InitialConditionFunction_NavierStokesBase<dim, nstate, real>
{
protected:
    /// Value of initial condition expressed in terms of primitive variables
    real primitive_value(const dealii::Point<dim, real>& point, const unsigned int istate = 0) const override;
