...
#include "../multispecies_euler.h" // for Multispecies Euler Base class
...
template <int dim, int nspecies, int nstate, typename real>
class InitialConditionFunction_MultispeciesEulerBase : public InitialConditionFunction<dim, nspecies, nstate, real>
{
protected:
    using dealii::Function<dim, real>::value; ///< dealii::Function we are templating on
...
public:
    ...
    explicit InitialConditionFunction_MultispeciesEulerBase(
        Parameters::AllParameters const* const param);
 ...
 */
template <int dim, int nspecies, int nstate, typename real>
class InitialConditionFunction_Multispecies_SodShockTube: public InitialConditionFunction_MultispeciesEulerBase<dim,nspecies,nstate,real>
{
public:
 ...
 */
template <int dim, int nspecies, int nstate, typename real>
class InitialConditionFunction_Multispecies_IsentropicVortex: public InitialConditionFunction_MultispeciesEulerBase<dim,nspecies,nstate,real>
{
public:
...
/// Initial Condition Function: Taylor Green Vortex (uniform density)
template <int dim, int nspecies, int nstate, typename real>
class InitialConditionFunction_Multispecies_TaylorGreenVortex : public InitialConditionFunction_MultispeciesEulerBase<dim,nspecies,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
