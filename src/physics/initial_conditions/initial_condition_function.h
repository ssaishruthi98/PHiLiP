...
/// 2D Initial Condition Function: InitialConditionFunction_Multispecies_HydrogenInjection
template <int dim, int nspecies, int nstate, typename real>
class InitialConditionFunction_Multispecies_HydrogenInjection: public InitialConditionFunction_RealGasBase<dim,nspecies,nstate,real>
{
public:
    /// Constructor for TaylorGreenVortex_InitialCondition with uniform density
    /** Calls the Function(const unsigned int n_components) constructor in deal.II
